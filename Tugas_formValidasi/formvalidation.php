...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($_POST["jp"])) {
            $error_jp = "Harap Mengisi Jenis Pendaftaran";
        } else {
        ...
        if (empty($_POST["tgl_masuk"])) {
            $error_tglmsk = "Harap Mengisi Tanggal Mauk";
        } else {
        ...
        // Nomor Peserta Ujian
        if (empty($_POST["npu"])) {
            $error_npu = "Harap Mengisi Nomor Pesarta Ujian";
        } else {
            $npu = cek_input($_POST["npu"]);
            if (!is_numeric($npu)) {
                $error_npu = "Hanya Boleh Angka";
            }
        }

        if (empty($_POST["pernah_paud"])) {
            $error_prnh_paud = "Harap Mengisi Terlebih Dahulu";
        } else {
            $pernah_paud = cek_input($_POST["pernah_paud"]);
        }

        if (empty($_POST["pernah_tk"])) {
            $error_prnh_tk = "Harap Mengisi Terlebih Dahulu";
        } else {
            $pernah_tk = cek_input($_POST["pernah_tk"]);
        }

        if (empty($_POST["skhun"])) {
            $error_skhun = "Harap Mengisi No. SKHUN";
        } else {
            $skhun = cek_input($_POST["skhun"]);
            if (!is_numeric($skhun)) {
                $error_skhun = "Hanya Dalam Bentuk Angka";
            }
        }

        if (empty($_POST["ijazah"])) {
            $error_ijazah = "Harap Mengisi No. Seri Ijazah";
        } else {
            $ijazah = cek_input($_POST["ijazah"]);
            if (!is_numeric($ijazah)) {
                $error_ijazah = "Hanya Boleh Angka";
            }
        }

        if (empty($_POST["hobi"])) {
            $error_hobi = "Harap Mengisi Hobi";
        } else {
                ...
                <div class="card-body">
                    <form method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="date" name="tgl_masuk" class="form-control" <?php echo ($error_tglmsk != "" ? "is-invalid" : ""); ?> id="tgl_masuk" value="<?php echo $tgl_masuk; ?>">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <span class="warning"><?php echo $error_prnh_paud; ?></span>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <span class="warning"><?php echo $error_prnh_tk; ?></span>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="kecamatan" class="form-control" <?php echo ($error_kec != "" ? "is-invalid" : ""); ?> id="kecamatan" placeholder="Kecamatan" value="<?php echo $kecamatan; ?>">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="namaayah" class="form-control" <?php echo ($error_nama_ayah != "" ? "is-invalid" : ""); ?>" id="namaayah" placeholder="Silahkan isi Nama Anda" value="<?php echo $namaayah; ?>">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="namaibu" class="form-control" <?php echo ($error_nama_ibu != "" ? "is-invalid" : ""); ?>" id="namaibu" placeholder="Silahkan isi Nama Anda" value="<?php echo $namaibu; ?>">
                            </div>
